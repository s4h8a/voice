    ...
    const businessProfile =
      ...
      (await this.prisma.businessProfile.create({
        data: {
          ...
          description: 'Demo business profile for consent-based AI calling.',
          productsServices: [{ name: 'Demo product', price: 999 }],
          pricing: [{ item: 'Demo product', amountPaise: 99900 }],
